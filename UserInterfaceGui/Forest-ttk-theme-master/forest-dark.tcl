...
namespace eval ttk::theme::forest-dark {
    ...
    ttk::style theme create forest-dark -parent default -settings {
        ttk::style configure . \
            ...
            -insertwidth 1 \
            -insertcolor $colors(-coloring) \
            -fieldbackground $colors(-selectbg) \
            -font {TkDefaultFont 10} \
            -borderwidth 1 \
            -relief flat \
            -coloring2 $colors(-coloring)
        ...
        # Elements
        # Tab
        # ttk::style configure TNotebook.Tab -foreground $colors(-coloring)
        # Label Frame
        # ttk::style configure TLabelFrame -foreground $colors(-coloring)

        # Label
        ttk::style configure TLabel -foreground $colors(-coloring)
        # Button
        ttk::style configure TButton -padding {8 4 8 4} -width -10 -anchor center
        #ttk::style configure TButton -foreground $colors(-coloring)
        ...
        # ttk::style configure TMenubutton -foreground $colors(-coloring)
        ...
        # ttk::style configure TOptionMenu -foreground $colors(-coloring)
        ...
        # ttk::style configure TCheckbutton -foreground $colors(-coloring)
        ...
        # ttk::style configure TRadiobutton -foreground $colors(-coloring)
